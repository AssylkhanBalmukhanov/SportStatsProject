...
## Minimum Semester Evidence

Each student should aim for:

- At least 5 merged PRs.
- At least 5 meaningful reviews.
- At least 5 closed issues assigned to them.
...
- Require at least one review from the other teammate.
- Include a short testing note in every PR.

## Candidate Issues

- Build Flask shell and navigation.
